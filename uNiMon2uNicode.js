// JavaScript Document from TalaChanMon and Reordering By JaMonRott in order to be able convert UniMon font.
function UniMon_Uni(input)
{
  var output=input;
   var tallAA = "\u102B";
   var AA = "\u102C";
...
document.body.innerHTML=UniMon_Uni(document.body.innerHTML);